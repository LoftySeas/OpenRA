...
dropdown-map-creeps =
    .label = 蠕虫单位
    .description = 敌对势力在战场上生成

resource-veins = Veins
resource-tiberium = 钛菌
...
faction-gdi =
    ...
    .description = 全球防御倡议
     GDI是联合国的一个国际军事分支，负责
     维护世界和平。指挥地球上
     最强大国家的联合力量，它拥有无与伦比的高科技武器库。

faction-nod =
    .name = Nod
    .description = Nod兄弟会
     兄弟会是一个以他们的领袖Kane
     和外星物质钛菌为中心的宗教教派。他们使用隐形技术
     和游击战术来击败那些反对他们的人。
...
notification-unable-to-comply-building-in-progress = 无法执行；建造中。
...
notification-emp-cannon-ready = EMP加农炮已准备。
...
## Infantry
notification-building-infiltrated = 建筑已渗透。
notification-building-captured = 建筑已被占领。
